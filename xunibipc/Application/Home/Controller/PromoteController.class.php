...
class PromoteController extends HomeController
{
	public function index($id = NULL)
	{
		...
		//select invit,sum(fee) as jiner from zhisucom_invit  where  group by invit ORDER BY jiner desc
		$where = "type like '%充值奖励%' and userid in (select id from zhisucom_user)";
