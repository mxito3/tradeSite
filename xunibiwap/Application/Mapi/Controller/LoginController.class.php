...
class LoginController extends CommonController
{
	...
	public function submit($username, $password)
	{
		...
		$rs[] = $mo->table('zhisucom_user_log')->add(array('userid' => $user['id'], 'type' => 'APP登录', 'remark' => $remark, 'addtime' => time(), 'addip' => get_client_ip(), 'addr' => get_city_ip(), 'status' => 1));
	...
	public function reg($username, $mobile, $password, $invit, $truename, $idcard, $paypassword, $reg_code)
	{
		...
		$rs = array();
		$rs[] = $mo->table('zhisucom_user')->add(array('username' => $username, 'password' => md5($password), 'invit' => $tradeno, 'idcard' => $idcard, 'moble' => $mobile, 'truename' => $truename, 'paypassword' => $paypassword, 'tpwdsetting' => 1, 'invit_1' => $invit_1, 'invit_2' => $invit_2, 'invit_3' => $invit_3, 'addip' => get_client_ip(), 'addr' => get_city_ip(), 'addtime' => time(), 'status' => 1));
