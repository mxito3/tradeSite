...
class TradeModel extends \Think\Model
{
						...
						if ($buy_fee) {
							if ($invit_buy_user['invit_1']) {
								...
								if (0 < $invit_buy_save_1) {
									...
									$finance_hash = md5($invit_buy_user['invit_1'] . $finance_num_user_coin['cny'] . $finance_num_user_coin['cnyd'] . $mum . $finance_mum_user_coin['cny'] . $finance_mum_user_coin['cnyd'] . MSCODE . 'auth.btchanges.com');
									$finance_num = $finance_num_user_coin['cny'] + $finance_num_user_coin['cnyd'];
							...
							if ($invit_buy_user['invit_2']) {
								...
								if (0 < $invit_buy_save_2) {
									...
									$finance_hash = md5($invit_buy_user['invit_2'] . $finance_num_user_coin['cny'] . $finance_num_user_coin['cnyd'] . $mum . $finance_mum_user_coin['cny'] . $finance_mum_user_coin['cnyd'] . MSCODE . 'auth.btchanges.com');
									$finance_num = $finance_num_user_coin['cny'] + $finance_num_user_coin['cnyd'];
							...
							if ($invit_buy_user['invit_3']) {
								...
								if (0 < $invit_buy_save_3) {
									...
									$finance_hash = md5($invit_buy_user['invit_3'] . $finance_num_user_coin['cny'] . $finance_num_user_coin['cnyd'] . $mum . $finance_mum_user_coin['cny'] . $finance_mum_user_coin['cnyd'] . MSCODE . 'auth.btchanges.com');
									$finance_num = $finance_num_user_coin['cny'] + $finance_num_user_coin['cnyd'];
						...
						if ($sell_fee) {
							if ($invit_sell_user['invit_1']) {
								...
								if (0 < $invit_sell_save_1) {
									...
									$finance_hash = md5($invit_sell_user['invit_1'] . $finance_num_user_coin['cny'] . $finance_num_user_coin['cnyd'] . $mum . $finance_mum_user_coin['cny'] . $finance_mum_user_coin['cnyd'] . MSCODE . 'auth.btchanges.com');
									$finance_num = $finance_num_user_coin['cny'] + $finance_num_user_coin['cnyd'];
							...
							if ($invit_sell_user['invit_2']) {
								...
								if (0 < $invit_sell_save_2) {
									...
									$finance_hash = md5($invit_sell_user['invit_2'] . $finance_num_user_coin['cny'] . $finance_num_user_coin['cnyd'] . $mum . $finance_mum_user_coin['cny'] . $finance_mum_user_coin['cnyd'] . MSCODE . 'auth.btchanges.com');
									$finance_num = $finance_num_user_coin['cny'] + $finance_num_user_coin['cnyd'];
							...
							if ($invit_sell_user['invit_3']) {
								...
								if (0 < $invit_sell_save_3) {
									...
									$finance_hash = md5($invit_sell_user['invit_3'] . $finance_num_user_coin['cny'] . $finance_num_user_coin['cnyd'] . $mum . $finance_mum_user_coin['cny'] . $finance_mum_user_coin['cnyd'] . MSCODE . 'auth.btchanges.com');
									$finance_num = $finance_num_user_coin['cny'] + $finance_num_user_coin['cnyd'];
	...
	public function chexiao($id = NULL)
	{
		...
		$mo = M();
		$mo->execute('set autocommit=0');
		$mo->execute('lock tables zhisucom_user_coin write  , zhisucom_trade write ,zhisucom_finance write');
		$rs = array();
		$user_coin = $mo->table('zhisucom_user_coin')->where(array('userid' => $trade['userid']))->find();
		...
		if ($trade['type'] == 1) {
			...
			$finance_hash = md5($trade['userid'] . $finance_num_user_coin['cny'] . $finance_num_user_coin['cnyd'] . $save_buy_rmb . $finance_mum_user_coin['cny'] . $finance_mum_user_coin['cnyd'] . MSCODE . 'auth.btchanges.com');
			$finance_num = $finance_num_user_coin['cny'] + $finance_num_user_coin['cnyd'];
			...
			if (!$you_sell) {
				...
				if (0 < $you_user_sell[$xnb . 'd']) {
					$mo->table('zhisucom_user_coin')->where(array('userid' => $trade['userid']))->setField($xnb . 'd', 0);
				}
			}
		}
		else {
