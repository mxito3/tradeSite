...
class LoginController extends HomeController
{
	...
	public function upregister($username, $password, $repassword, $verify, $invit, $moble, $moble_verify)
	{
		...
		$rs = array();
		$rs[] = $mo->table('zhisucom_user')->add(array('username' => $username, 'moble' => $moble, 'mobletime' => time(), 'password' => md5($password), 'invit' => $tradeno, 'tpwdsetting' => 1, 'invit_1' => $invit_1, 'invit_2' => $invit_2, 'invit_3' => $invit_3, 'addip' => get_client_ip(), 'addr' => get_city_ip(), 'addtime' => time(), 'status' => 1));
	...
	public function submit($username, $password, $verify = NULL)
	{
		...
		$rs[] = $mo->table('zhisucom_user_log')->add(array('userid' => $user['id'], 'type' => '登录', 'remark' => $remark, 'addtime' => time(), 'addip' => get_client_ip(), 'addr' => get_city_ip(), 'status' => 1));
