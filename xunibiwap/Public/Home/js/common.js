...
AJAX = {
    ...
    layertpwd: function(){
        ...
        var html = '<div id="all_mask" class="all_mask"></div><div id="tpwd" class="all_mask_loginbox">' +
            ...
            '<ul class="tpwd">' +
            '<label for="every"><input checked type="radio" id="none" name="tpwdsetting" value="4"> 每次交易都不需要输入交易密码</label></li><li><label for="none">' +
            '<input type="radio" id="every" value="1" name="tpwdsetting"> 每笔交易都输入交易密码</label></li><li><input type="password" name="pwtrade" placeholder="请输入交易密码" class="text"/>' +
	...
	tradeadd: function(type){
		...
		if(isNaN(tNum.val()) || isNaN(tPrice.val())){
			...
			(isNaN(tPrice.val())?tPrice:tNum).css({'box-shadow':'0px 0px 3px #ed4040','border':'1px solid #ed4040','color':'#333'});
			return false;
		}
        ...
        $.get('/coin/'+CONF.coin+'/trades?t='+AJAX.rd(), function(d){
            ...
            for(var i = 0; i< d.buy.length;i++){
                if(typeof d.buy[i] !='undefined' && typeof d.sell[i] !='undefined'){
                    ...
                    trades.infobuy.html +='<tr><td><span>'+ numbersplit(formatfloat(d.buy[i][0] * d.buy[i][1], 4))+'</span></td><td><span style="color:#ed4040;">'+ d.buy[i][1]+'</span></td> <td> <span>'+d.buy[i][0]+'</span><span data-count='+ d.buy[i][1]+' class="deepbar buy" style="top:'+(i+1)*36+'px;"></span></td>  </tr>'
	...
	alert: function(){
		...
		$.getJSON('/ajax/profit/alert',function(d){
                if(!d.status){
                    if(!$.cookie('alertmana')){
                    $('body').append('<div class="mana-adv mana-adv-up" style="padding:15px;"><p style="font-family:\'hiragino sans gb\';height:40px;line-height: 30px;">邀请用户赚佣金 <img onclick="hidemana(this);$.cookie(\'alertmana\',1,{expires:7});"  style="float:right;cursor:pointer;" src="/images/jubi/x.png" alt=""/> </p> <p style="font-size:14px;color:#777;">推荐动说给他人即可获得被推荐人半年内交易手续费的30%作为佣金</p> <a class="common-button" style="padding:8px 20px;border-radius:30px;display: inline-block;margin-left:65px;margin-top:15px;" href="/ajax/profit/activity">马上邀请</a> </div>');}
                }else{
                    if(!$.cookie('alertmana1')){
                    $('body').append('<div class="mana-adv mana-adv-up" style="width:260px;padding:15px;"><p style="font-family:\'hiragino sans gb\';height:40px;line-height: 30px;font-size:17px;">佣金收入 <img onclick="hidemana(this);$.cookie(\'alertmana1\',1,{expires:1});" style="float:right;cursor:pointer;" src="/images/jubi/x.png" alt=""/> </p> <p style="font-size:14px;color:#777;">'+ d.data.date+' <br/>成功邀请：<span style="color:#ed4040;">'+ d.data['cnt']+'人</span> <br/>佣金收入折合人民币：<span style="color:#ed4040;">'+ d.data['cny_total']+'元</span></p><a class="common-button" style="padding:8px 20px;border-radius:30px;display: inline-block;margin-left:65px;margin-top:15px;" href="/finance/users.html">立即查看</a> </div>');}
            }
		});
	},
    ...
    alertbtc:function(flag){
        ...
        warinhtml += '<div class="dialog-step-1">为了给用户提供更优质的服务， <em style="color:#ed4040;font-style:normal;">自7月1日起</em>，动说网比特币（BTC）交易业务将全部转至比特币交易网，该平台免收BTC交易手续费并拥有更活跃的市场，动说网将不再提供比特币买卖、转入服务，若给您带来不便敬请谅解。您可以点击下面按钮将BTC一键转存至比特币交易网。<p  style=" margin: 10px 0; ">若您有挂单冻结的比特币资产，请先撤销挂单后再进行转出操作。 <a style="  color: #ed4040;text-decoration: underline;" href="/finance/trades.html">立即去撤单</a></p><p>请您于 <em style="color:#ed4040;font-style:normal;">7月15日24：00</em>之前完成BTC的转出操作，衷心感谢您的理解与支持。</p>';
        ...
        warinthree += '<div style="text-align:center;padding:35px;font-size:16px;"><div style="font-size:20px;color:#690;"><i style="vertical-align: middle;" class="fa fa-2x fa-check"></i> 创建成功</div>你在BtcTrade的账号为 <span style="color:#ed4040;"> '+USER[1]+'</span><div>登录密码，交易密码与动说相同</div></span>   ';
	...
	alertdrk: function () {
		if(!$.cookie('alertbtccookie')) {
			...
			warinhtml += '<div class="ui-dialog-title" onselectstart="return false">';
			warinhtml += '<span class="dialog-step-1" style="color: #ffffff">尊敬的动说用户:</span><span class="dialog-step-2">转出达世币</span>';
			warinhtml += '<a class="ui-dialog-closebutton" onclick="lcookie()">&times;</a>';
			warinhtml += '</div>';
			warinhtml += '<div class="ui-dialog-content">';
			warinhtml += '<div class="dialog-step-1">您好！由于动说网达世币长期交易量过低，平台基于对资产安全和用户体验考虑，计划于 <em style="color:#ed4040;font-style:normal;">2015年9月17日</em>下线达世币，请相关用户妥善处理在平台的达世币资产。<p  style=" margin: 10px 0; ">若您有挂单冻结的达世币资产，请先撤销挂单后再进行转出操作。 <a style="  color: #ed4040;text-decoration: underline;" onclick="lcookie()" href="/finance/trades.html?coin=drk">立即去撤单</a></p><p>请您于 <em style="color:#ed4040;font-style:normal;">9月17日24：00</em>之前完成DRK的转出操作，衷心感谢您的理解与支持。</p>';
    ...
    check:function(){
        $.getJSON('/ajax/user/check',function(d){
            ...
            // 已经有账户
                ...
                $('#accountmsg').html('您在BtcTrade账号为: <em style="font-style: normal;color:#ed4040;">'+USER[1]+'</em><br> 您可一键转入BtcTrade账户进行交易');
                $('#tradeacc').on('click', function () {
                    AJAX.sync_btc();
                })
            }
...
function change_bg(id){
	...
	for(var i=0;i<oC_li.length;i++){
		...
		oInp.mouseover(function(){this.style.color='#fff';this.style.backgroundColor='#ed4040'});
		oInp.mouseout(function(){this.style.color='#ed4040';this.style.background='none'});
	}
}
...
$(function(){
	...
	if(os.isPc){
		$('body').append('<div class="sidetool hidden-xs"><ul><li><a href="http://wpa.b.qq.com/cgi/wpa.php?ln=1&key=XzkzODAyNDczN18xNjMyMjVfNDAwNjU3ODg4MF8yXw" target="_blank"><i class="sidetool-item qq"></i></a><span style="cursor:pointer;" onclick="window.open(\'http://wpa.b.qq.com/cgi/wpa.php?ln=1&key=XzkzODAyNDczN18xNjMyMjVfNDAwNjU3ODg4MF8yXw\')">QQ在线客服</span></li><li><a href=""><i class="sidetool-item wechat"></i></a><span class="sqrcode"><img src="/images/jubi/wx-qrcode.png" alt=""><i>动说网微信公众号</i></span></li><li><a href=""><i class="sidetool-item mobile"></i></a><span class="sqrcode"><img width="100" style="background-color: #fff;" src="/images/jubi/jubi-app.png" alt=""><i>动说网手机APP下载</i></li><li><a href=""><i class="sidetool-item tel"></i></a><span>400-657-8880</span></li></ul></div>');
	}
    $('.footer_bottom').prepend('<div class="autobox"><span style="display: inline-block;color:#a6a9ab;">CopyRight© 2013-2016动说网All Rights Reserved. Powered by聚维（北京）科技有限公司 | 工商注册号：110105016727871 &nbsp;&nbsp;|&nbsp;&nbsp;<a href="http://www.miitbeian.gov.cn/publish/query/indexFirst.action" target="_blank">京ICP备14009321号</a><br/>京公网安备11010802018020号  | 地址：北京市海淀区人大北路33号大行基业大厦1411｜<a href="/">jubi.com</a>&nbsp;&nbsp;|&nbsp;&nbsp;<a href="/about/join.html">加入我们</a>&nbsp;&nbsp;|&nbsp;&nbsp;<a href="/help/api.html">API</a></span> <span style="display: inline-block; color:#a6a9ab"></span><a style="float:right;margin-top:5px;" id=\'___szfw_logo___\' href=\'https://credit.szfw.org/CX20151225013017170181.html\' target=\'_blank\'> <img src=\'http://icon.szfw.org/cert.png\' style="vertical-align:middle;" height="29" border=\'0\' /></a><script type="text/javascript">(function(){document.getElementById("___szfw_logo___").oncontextmenu = function(){return false;}})();</script></div>')
    //底部替换
...
function renderPage(ary){
    ...
    for(var i in ary){
        var coinfinance = 0;
        if(typeof FINANCE == 'object') coinfinance = parseFloat(FINANCE.data[ary[i][9]+'_balance']);
        html+= '<li><dl class="autobox clear"><dt><i></i><a href="/coin/'+ary[i][9]+'/"><em class="deal_list_pic_'+ary[i][9]+'"></em><p>'+ary[i][0]+'('+ ary[i][9].toUpperCase() +')</p></a></dt><dd class="orange">￥'+ary[i][1]+'</dd><dd>￥'+formatCount(parseInt(ary[i][7]))+'</dd><dd class="w142">'+formatCount(ary[i][6])+'</dd><dd class="w142 '+ (ary[i][8]>=0 ? 'red':'green')+'" style="text-indent:2.8em;color:red">'+(parseFloat(ary[i][8])<0 ? '':'+')+ ((parseFloat(ary[i][8]) < 0.01 && parseFloat(ary[i][8])>-0.01) ?"0.00":ary[i][8])+'%</dd><dd id="'+ary[i][9]+'_plot"  style="width:120px;height:35px;"></dd><dd class="w102" style="text-indent:0em;margin-left:10px"><input type="button" value="去交易" onclick="top.location=\'/coin/'+ary[i][9]+'/\'" /></dd></dl></li>'
    }
...
function vip_ds(){
    ...
    html +=    '<p>您好！</p>'
    html +=        ' <p>首先感谢您对动说的长期支持！根据您在动说充值、交易的状况及活跃程度，祝贺您升级为动说VIP用户！</p>'
    html +=       ' <p>您的动说账号将增加<img height="15" style="vertical-align:text-top;margin:0 3px;" src="/images/jubi/vip.png" alt=""/>标识，同时您将享受到以下所有VIP待遇：</p>'
    html +=       ' <ol>'
        html +=            '<li>交易手续费为 <em>0.8‰</em>。</li>'
        html +=            '<li>VIP用户的提现申请将被<em>优先受理</em>。</li>'
        html +=           ' <li>申请成为经理人，邀请新用户可享受<em>35%</em>的交易手续费返佣。</li>'
        html +=            '<li>能<em>优先</em>参与动说各类活动、评测体验动说新产品。</li>'
        html +=            '<li>VIP用户在比特币交易网（www.btctrade.com）也有账户，经申请能升级成为<em>比特币交易网VIP用户</em>。（注册邮箱、绑定手机、实名认证信息，这三项信息有一项与动说账号相同即可）</li>'
        html +=            '<li>VIP用户享有与动说网相关合作在同等条件下的 <em> 优先权</em>。</li>'
        html +=       '</ol>'
    html +=       ' <p style="margin-top:20px;font-size:13px;color:#666;">感谢您一直以来对动说网的支持，我们会用优质与专业的服务回馈您对我们的信任。如有疑问请随时咨询客服，电话：400-657-8880</p>'
    html +=   '</div>'
    html += '</div>'
